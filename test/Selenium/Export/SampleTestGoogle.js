...
var browser, element, currentCommand = '',
    options = {
        timeout: 30000,
        retries: 0,
        screenshotFolder: 'screenshots/SampleTestGoogle',
        baseUrl: 'http://change-this-to-the-site-you-are-testing/'
    };

module.exports = function testSampleTestGoogle(_browser, _options) {

    browser = _browser;
    var acceptNextAlert = true;
    getRuntimeOptions(_options);
    try {
        currentCommand = 'open("http://www.google.com", "")';
        browser.get(addBaseUrl("http://www.google.com"));
